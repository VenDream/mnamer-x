...
你需要以JSON数组的格式返回，且包含以下字段
- "original": "xx"   // 原文件名
- "name": "xx",      // 电影名/剧名，不能带有点号，换成空格，无法识别则填充为空字符串
- "year": "20xx",    // 年份，无法识别则填充为空字符串
- "season": 1,       // 剧集季数，无法识别则填充为1
- "episode": 0,      // 剧集集数，无法识别则填充为1
- "resolution": "4K" // 清晰度或分辨率, 无法识别则填充为空字符串
- "misc": "xx.xx.xx" // 格式/编码/版本/压制组等其他信息, 无法识别则填充为空字符串
- "format": "mp4"    // 文件后缀名，无法识别则填充为空字符串
